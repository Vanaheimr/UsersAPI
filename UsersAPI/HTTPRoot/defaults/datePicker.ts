...
class DatePicker
{
    ...
    private resultDelegate: (result: string) => void;
    private centerDiv:      HTMLDivElement;
    private daysDiv:        HTMLDivElement;
    ...
    public show(InputDiv:        HTMLDivElement,
                StartDateUTC:    string,
                resultDelegate:  (result: string) => void)
    {
        ...
        this.centerDiv = topDiv.appendChild(document.createElement('div')) as HTMLDivElement;
        ...
        this.daysDiv = this.frameDiv.appendChild(document.createElement('div')) as HTMLDivElement;
        this.daysDiv.className = "days";

        const removeDateDiv = this.frameDiv.appendChild(document.createElement('div')) as HTMLDivElement;
    ...
    public hide(ev: MouseEvent) {
        ...
        try
        {
            ...
            let clickedDiv = ev.target as HTMLElement;
