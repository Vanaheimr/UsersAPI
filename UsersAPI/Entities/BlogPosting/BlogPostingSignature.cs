...
namespace social.OpenData.UsersAPI.Postings
{
    ...
    /// <summary>
    /// An Open Data blog posting signature.
    /// </summary>
    public class BlogPostingSignature
    {
        ...
        /// <summary>
        /// Create a new Open Data blog posting signature.
        /// </summary>
        ...
        public BlogPostingSignature(String  InputFormat,
                                    String  Algorithm,
                                    String  OutputFormat,
                                    String  Value)
        {
